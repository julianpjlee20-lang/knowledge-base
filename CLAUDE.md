...
- Put AI behavior memory and durable user preferences in `agents-memory`, not this repo.
...
- GitHub: `https://github.com/julianpjlee20-lang/agents-memory`
- Local Windows path: `C:/Users/user/agents-memory`
